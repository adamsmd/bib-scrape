...
@article{Kramer:1955:10.1007/BF01975012,
  ...
  abstract = {Der Versuch, bei Brieftauben durch zeitweisen Entzug der Sonnensicht eine Orientierungst{\"a}uschung hervorzurufen, verlief auch im Herbst 1954 erfolglos. (Negativer Ausfall des ersten Wilhelmshavener Versuchs: K. und{\small A. Rawson}, diese Ztschr., dieses Heft, S. 168.)
{\par}
Dieser Ausfall spricht zun{\"a}chst gegen die{\small Matthewss}che Hypothese der Sonnennavigation, ohne jedoch unbedingt t{\"o}dlich f{\"u}r sie zu sein (s. Diskussion, S. 176).
{\par}
...
{\par}
The sun occlusion experiment as proposed by{\small Matthews} was again repeated with a negative result. (First repeat in Wilhelmshaven, also with a negative result: K. and{\small A. Rawson}, this volume p. 168.)
{\par}
