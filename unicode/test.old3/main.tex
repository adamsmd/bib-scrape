...
% Note: {metre} must load before {amsmath}
% {metre} is for \metra
% {fixltx2e} is for \textsubscript
% {mathrsfs} is for \mathscr
% {marvosym} is for \Pfund and \fax
% {mathdots} is for \iddots
% {mathbbol} is for \Lparen and \Rparen
% {shuffle} is for \shuffle
% {tipa} is for \textschwa
% {wasysym} is for \diameter, \invneg, \wasylozenge, and \recorder
2000 X{\enskip}X
