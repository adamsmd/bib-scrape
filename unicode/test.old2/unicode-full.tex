...
%0126 294 {\fontencoding{LELA}\selectfont\char40}

%0127 295 \ensuremath{\Elzxh}
...
%0138 312 {\fontencoding{LELA}\selectfont\char91}
...
%013f 319 {\fontencoding{LELA}\selectfont\char201}

%0140 320 {\fontencoding{LELA}\selectfont\char202}
...
%0166 358 {\fontencoding{LELA}\selectfont\char47}

%0167 359 {\fontencoding{LELA}\selectfont\char63}
...
%01ba 442 {\fontencoding{LELA}\selectfont\char195}

%01c2 450 \textdoublepipe

01f5 501 \'g

%0250 592 \ensuremath{\Elztrna}

%0252 594 \ensuremath{\Elztrnsa}

%0254 596 \ensuremath{\Elzopeno}

%0256 598 \ensuremath{\Elzrtld}

%0258 600 {\fontencoding{LEIP}\selectfont\char61}

%0259 601 \ensuremath{\Elzschwa}

025b 603 \ensuremath{\varepsilon}

0261 609 g

%0263 611 \ensuremath{\Elzpgamma}

%0264 612 \ensuremath{\Elzpbgam}

%0265 613 \ensuremath{\Elztrnh}

%026c 620 \ensuremath{\Elzbtdl}

%026d 621 \ensuremath{\Elzrtll}

%026f 623 \ensuremath{\Elztrnm}

%0270 624 \ensuremath{\Elztrnmlr}

%0271 625 \ensuremath{\Elzltlmr}

%0272 626 \Elzltln

%0273 627 \ensuremath{\Elzrtln}

%0277 631 \ensuremath{\Elzclomeg}

%0278 632 \textphi

%0279 633 \ensuremath{\Elztrnr}

%027a 634 \ensuremath{\Elztrnrl}

%027b 635 \ensuremath{\Elzrttrnr}

%027c 636 \ensuremath{\Elzrl}

%027d 637 \ensuremath{\Elzrtlr}

%027e 638 \ensuremath{\Elzfhr}

%027f 639 {\fontencoding{LEIP}\selectfont\char202}

%0282 642 \ensuremath{\Elzrtls}

%0283 643 \ensuremath{\Elzesh}

%0287 647 \ensuremath{\Elztrnt}

%0288 648 \ensuremath{\Elzrtlt}

%028a 650 \ensuremath{\Elzpupsil}

%028b 651 \ensuremath{\Elzpscrv}

%028c 652 \ensuremath{\Elzinvv}

%028d 653 \ensuremath{\Elzinvw}

%028e 654 \ensuremath{\Elztrny}

%0290 656 \ensuremath{\Elzrtlz}

%0292 658 \ensuremath{\Elzyogh}

%0294 660 \ensuremath{\Elzglst}

%0295 661 \ensuremath{\Elzreglst}

%0296 662 \ensuremath{\Elzinglst}

%029e 670 \textturnk

%02a4 676 \ensuremath{\Elzdyogh}

%02a7 679 \ensuremath{\Elztesh}

%02bc 700 \rasp

02c7 711 \textasciicaron

%02c8 712 \ensuremath{\Elzverts}

%02cc 716 \ensuremath{\Elzverti}

%02d0 720 \ensuremath{\Elzlmrk}

%02d1 721 \ensuremath{\Elzhlmrk}

%02d2 722 \ensuremath{\Elzsbrhr}

%02d3 723 \ensuremath{\Elzsblhr}

%02d4 724 \ensuremath{\Elzrais}

%02d5 725 \ensuremath{\Elzlow}
...
%0311 785 {\fontencoding{LECO}\selectfont\char177}

%0318 792 {\fontencoding{LECO}\selectfont\char184}

%0319 793 {\fontencoding{LECO}\selectfont\char185}

%0321 801 \ensuremath{\Elzpalh}
...
%032a 810 \ensuremath{\Elzsbbrg}

%032b 811 {\fontencoding{LECO}\selectfont\char203}

%032f 815 {\fontencoding{LECO}\selectfont\char207}

%0335 821 \Elzxl

%0336 822 \Elzbar

%0337 823 {\fontencoding{LECO}\selectfont\char215}
%
%0338 824 {\fontencoding{LECO}\selectfont\char216}
%
%033a 826 {\fontencoding{LECO}\selectfont\char218}
%
%033b 827 {\fontencoding{LECO}\selectfont\char219}
%
%033c 828 {\fontencoding{LECO}\selectfont\char220}
%
%033d 829 {\fontencoding{LECO}\selectfont\char221}
%
%0361 865 {\fontencoding{LECO}\selectfont\char225}
...
%0391 913 \ensuremath{\Alpha}

%0392 914 \ensuremath{\Beta}

0393 915 \ensuremath{\Gamma}

0394 916 \ensuremath{\Delta}

%0395 917 \ensuremath{\Epsilon}

%0396 918 \ensuremath{\Zeta}

%0397 919 \ensuremath{\Eta}

0398 920 \ensuremath{\Theta}

%0399 921 \ensuremath{\Iota}

%039a 922 \ensuremath{\Kappa}
...
03d0 976 \Pisymbol{ppi022}{87}

%03d1 977 \textvartheta
...
%0401 1025 \cyrchar\CYRYO
%
%0402 1026 \cyrchar\CYRDJE
%
%0403 1027 \cyrchar{\'\CYRG}
%
%0404 1028 \cyrchar\CYRIE
%
%0405 1029 \cyrchar\CYRDZE
%
%0406 1030 \cyrchar\CYRII
%
%0407 1031 \cyrchar\CYRYI
%
%0408 1032 \cyrchar\CYRJE
%
%0409 1033 \cyrchar\CYRLJE
%
%040a 1034 \cyrchar\CYRNJE
%
%040b 1035 \cyrchar\CYRTSHE
%
%040c 1036 \cyrchar{\'\CYRK}
%
%040e 1038 \cyrchar\CYRUSHRT
%
%040f 1039 \cyrchar\CYRDZHE
%
%0410 1040 \cyrchar\CYRA
%
%0411 1041 \cyrchar\CYRB
%
%0412 1042 \cyrchar\CYRV
%
%0413 1043 \cyrchar\CYRG
%
%0414 1044 \cyrchar\CYRD
%
%0415 1045 \cyrchar\CYRE
%
%0416 1046 \cyrchar\CYRZH
%
%0417 1047 \cyrchar\CYRZ
%
%0418 1048 \cyrchar\CYRI
%
%0419 1049 \cyrchar\CYRISHRT
%
%041a 1050 \cyrchar\CYRK
%
%041b 1051 \cyrchar\CYRL
%
%041c 1052 \cyrchar\CYRM
%
%041d 1053 \cyrchar\CYRN
%
%041e 1054 \cyrchar\CYRO
%
%041f 1055 \cyrchar\CYRP
%
%0420 1056 \cyrchar\CYRR
%
%0421 1057 \cyrchar\CYRS
%
%0422 1058 \cyrchar\CYRT
%
%0423 1059 \cyrchar\CYRU
%
%0424 1060 \cyrchar\CYRF
%
%0425 1061 \cyrchar\CYRH
%
%0426 1062 \cyrchar\CYRC
%
%0427 1063 \cyrchar\CYRCH
%
%0428 1064 \cyrchar\CYRSH
%
%0429 1065 \cyrchar\CYRSHCH
%
%042a 1066 \cyrchar\CYRHRDSN
%
%042b 1067 \cyrchar\CYRERY
%
%042c 1068 \cyrchar\CYRSFTSN
%
%042d 1069 \cyrchar\CYREREV
%
%042e 1070 \cyrchar\CYRYU
%
%042f 1071 \cyrchar\CYRYA
%
%0430 1072 \cyrchar\cyra
%
%0431 1073 \cyrchar\cyrb
%
%0432 1074 \cyrchar\cyrv
%
%0433 1075 \cyrchar\cyrg
%
%0434 1076 \cyrchar\cyrd
%
%0435 1077 \cyrchar\cyre
%
%0436 1078 \cyrchar\cyrzh
%
%0437 1079 \cyrchar\cyrz
%
%0438 1080 \cyrchar\cyri
%
%0439 1081 \cyrchar\cyrishrt
%
%043a 1082 \cyrchar\cyrk
%
%043b 1083 \cyrchar\cyrl
%
%043c 1084 \cyrchar\cyrm
%
%043d 1085 \cyrchar\cyrn
%
%043e 1086 \cyrchar\cyro
%
%043f 1087 \cyrchar\cyrp
%
%0440 1088 \cyrchar\cyrr
%
%0441 1089 \cyrchar\cyrs
%
%0442 1090 \cyrchar\cyrt
%
%0443 1091 \cyrchar\cyru
%
%0444 1092 \cyrchar\cyrf
%
%0445 1093 \cyrchar\cyrh
%
%0446 1094 \cyrchar\cyrc
%
%0447 1095 \cyrchar\cyrch
%
%0448 1096 \cyrchar\cyrsh
%
%0449 1097 \cyrchar\cyrshch
%
%044a 1098 \cyrchar\cyrhrdsn
%
%044b 1099 \cyrchar\cyrery
%
%044c 1100 \cyrchar\cyrsftsn
%
%044d 1101 \cyrchar\cyrerev
%
%044e 1102 \cyrchar\cyryu
%
%044f 1103 \cyrchar\cyrya
%
%0451 1105 \cyrchar\cyryo
%
%0452 1106 \cyrchar\cyrdje
%
%0453 1107 \cyrchar{\'\cyrg}
%
%0454 1108 \cyrchar\cyrie
%
%0455 1109 \cyrchar\cyrdze
%
%0456 1110 \cyrchar\cyrii
%
%0457 1111 \cyrchar\cyryi
%
%0458 1112 \cyrchar\cyrje
%
%0459 1113 \cyrchar\cyrlje
%
%045a 1114 \cyrchar\cyrnje
%
%045b 1115 \cyrchar\cyrtshe
%
%045c 1116 \cyrchar{\'\cyrk}
%
%045e 1118 \cyrchar\cyrushrt
%
%045f 1119 \cyrchar\cyrdzhe
%
%0460 1120 \cyrchar\CYROMEGA
%
%0461 1121 \cyrchar\cyromega
%
%0462 1122 \cyrchar\CYRYAT
%
%0464 1124 \cyrchar\CYRIOTE
%
%0465 1125 \cyrchar\cyriote
%
%0466 1126 \cyrchar\CYRLYUS
%
%0467 1127 \cyrchar\cyrlyus
%
%0468 1128 \cyrchar\CYRIOTLYUS
%
%0469 1129 \cyrchar\cyriotlyus
%
%046a 1130 \cyrchar\CYRBYUS
%
%046c 1132 \cyrchar\CYRIOTBYUS
%
%046d 1133 \cyrchar\cyriotbyus
%
%046e 1134 \cyrchar\CYRKSI
%
%046f 1135 \cyrchar\cyrksi
%
%0470 1136 \cyrchar\CYRPSI
%
%0471 1137 \cyrchar\cyrpsi
%
%0472 1138 \cyrchar\CYRFITA
%
%0474 1140 \cyrchar\CYRIZH
%
%0478 1144 \cyrchar\CYRUK
%
%0479 1145 \cyrchar\cyruk
%
%047a 1146 \cyrchar\CYROMEGARND
%
%047b 1147 \cyrchar\cyromegarnd
%
%047c 1148 \cyrchar\CYROMEGATITLO
%
%047d 1149 \cyrchar\cyromegatitlo
%
%047e 1150 \cyrchar\CYROT
%
%047f 1151 \cyrchar\cyrot
%
%0480 1152 \cyrchar\CYRKOPPA
%
%0481 1153 \cyrchar\cyrkoppa
%
%0482 1154 \cyrchar\cyrthousands
%
%0488 1160 \cyrchar\cyrhundredthousands
%
%0489 1161 \cyrchar\cyrmillions
%
%048c 1164 \cyrchar\CYRSEMISFTSN
%
%048d 1165 \cyrchar\cyrsemisftsn
%
%048e 1166 \cyrchar\CYRRTICK
%
%048f 1167 \cyrchar\cyrrtick
%
%0490 1168 \cyrchar\CYRGUP
%
%0491 1169 \cyrchar\cyrgup
%
%0492 1170 \cyrchar\CYRGHCRS
%
%0493 1171 \cyrchar\cyrghcrs
%
%0494 1172 \cyrchar\CYRGHK
%
%0495 1173 \cyrchar\cyrghk
%
%0496 1174 \cyrchar\CYRZHDSC
%
%0497 1175 \cyrchar\cyrzhdsc
%
%0498 1176 \cyrchar\CYRZDSC
%
%0499 1177 \cyrchar\cyrzdsc
%
%049a 1178 \cyrchar\CYRKDSC
%
%049b 1179 \cyrchar\cyrkdsc
%
%049c 1180 \cyrchar\CYRKVCRS
%
%049d 1181 \cyrchar\cyrkvcrs
%
%049e 1182 \cyrchar\CYRKHCRS
%
%049f 1183 \cyrchar\cyrkhcrs
%
%04a0 1184 \cyrchar\CYRKBEAK
%
%04a1 1185 \cyrchar\cyrkbeak
%
%04a2 1186 \cyrchar\CYRNDSC
%
%04a3 1187 \cyrchar\cyrndsc
%
%04a4 1188 \cyrchar\CYRNG
%
%04a5 1189 \cyrchar\cyrng
%
%04a6 1190 \cyrchar\CYRPHK
%
%04a7 1191 \cyrchar\cyrphk
%
%04a8 1192 \cyrchar\CYRABHHA
%
%04a9 1193 \cyrchar\cyrabhha
%
%04aa 1194 \cyrchar\CYRSDSC
%
%04ab 1195 \cyrchar\cyrsdsc
%
%04ac 1196 \cyrchar\CYRTDSC
%
%04ad 1197 \cyrchar\cyrtdsc
%
%04ae 1198 \cyrchar\CYRY
%
%04af 1199 \cyrchar\cyry
%
%04b0 1200 \cyrchar\CYRYHCRS
%
%04b1 1201 \cyrchar\cyryhcrs
%
%04b2 1202 \cyrchar\CYRHDSC
%
%04b3 1203 \cyrchar\cyrhdsc
%
%04b4 1204 \cyrchar\CYRTETSE
%
%04b5 1205 \cyrchar\cyrtetse
%
%04b6 1206 \cyrchar\CYRCHRDSC
%
%04b7 1207 \cyrchar\cyrchrdsc
%
%04b8 1208 \cyrchar\CYRCHVCRS
%
%04b9 1209 \cyrchar\cyrchvcrs
%
%04ba 1210 \cyrchar\CYRSHHA
%
%04bb 1211 \cyrchar\cyrshha
%
%04bc 1212 \cyrchar\CYRABHCH
%
%04bd 1213 \cyrchar\cyrabhch
%
%04be 1214 \cyrchar\CYRABHCHDSC
%
%04bf 1215 \cyrchar\cyrabhchdsc
%
%04c0 1216 \cyrchar\CYRpalochka
%
%04c3 1219 \cyrchar\CYRKHK
%
%04c4 1220 \cyrchar\cyrkhk
%
%04c7 1223 \cyrchar\CYRNHK
%
%04c8 1224 \cyrchar\cyrnhk
%
%04cb 1227 \cyrchar\CYRCHLDSC
%
%04cc 1228 \cyrchar\cyrchldsc
%
%04d4 1236 \cyrchar\CYRAE
%
%04d5 1237 \cyrchar\cyrae
%
%04d8 1240 \cyrchar\CYRSCHWA
%
%04d9 1241 \cyrchar\cyrschwa
%
%04e0 1248 \cyrchar\CYRABHDZE
%
%04e1 1249 \cyrchar\cyrabhdze
%
%04e8 1256 \cyrchar\CYROTLD
%
%04e9 1257 \cyrchar\cyrotld
...
%201b 8219 \ensuremath{\Elzreapos}
...
%20a7 8359 \ensuremath{\Elzpes}

20ac 8364 \mbox{\texteuro}
...
%2129 8489 \ensuremath{\ElsevierGlyph{2129}}
...
%2153 8531 \ensuremath{\textfrac{1}{3}}
%
%2154 8532 \ensuremath{\textfrac{2}{3}}
%
%2155 8533 \ensuremath{\textfrac{1}{5}}
%
%2156 8534 \ensuremath{\textfrac{2}{5}}
%
%2157 8535 \ensuremath{\textfrac{3}{5}}
%
%2158 8536 \ensuremath{\textfrac{4}{5}}
%
%2159 8537 \ensuremath{\textfrac{1}{6}}
%
%215a 8538 \ensuremath{\textfrac{5}{6}}
%
%215b 8539 \ensuremath{\textfrac{1}{8}}
%
%215c 8540 \ensuremath{\textfrac{3}{8}}
%
%215d 8541 \ensuremath{\textfrac{5}{8}}
%
%215e 8542 \ensuremath{\textfrac{7}{8}}
...
%21b3 8627 \ensuremath{\ElsevierGlyph{21B3}}
...
%2232 8754 \ensuremath{\ElsevierGlyph{2232}}

%2233 8755 \ensuremath{\ElsevierGlyph{2233}}
...
%225a 8794 \ensuremath{\ElsevierGlyph{225A}}
...
%2274 8820 \ensuremath{\ElsevierGlyph{2274}}

%2275 8821 \ensuremath{\ElsevierGlyph{2275}}
...
%22e5 8933 \ensuremath{\Elzsqspne}
...
%23a3 9123 \ensuremath{\Elzdlcorn}
...
%2506 9478 \ensuremath{\Elzdshfnc}

%2519 9497 \ensuremath{\Elzsqfnw}
...
%25af 9647 \ensuremath{\Elzvrecto}

%25b1 9649 \ensuremath{\ElsevierGlyph{E381}}
...
%25d0 9680 \ensuremath{\Elzcirfl}

%25d1 9681 \ensuremath{\Elzcirfr}

%25d2 9682 \ensuremath{\Elzcirfb}

25d7 9687 \ding{119}

%25d8 9688 \ensuremath{\Elzrvbull}

%25e7 9703 \ensuremath{\Elzsqfl}

%25e8 9704 \ensuremath{\Elzsqfr}

%25ea 9706 \ensuremath{\Elzsqfse}
...
%2905 10501 \ensuremath{\ElsevierGlyph{E212}}
...
%2923 10531 \ensuremath{\ElsevierGlyph{E20C}}

%2924 10532 \ensuremath{\ElsevierGlyph{E20D}}
...
%2933 10547 \ensuremath{\ElsevierGlyph{E21C}}

%2936 10550 \ensuremath{\ElsevierGlyph{E21A}}

%2937 10551 \ensuremath{\ElsevierGlyph{E219}}

2940 10560 \ensuremath{\circlearrowleft}

2941 10561 \ensuremath{\circlearrowright}

%2942 10562 \ensuremath{\ElzRlarr}

%2944 10564 \ensuremath{\ElzrLarr}

%2947 10567 \ensuremath{\Elzrarrx}
...
%297c 10620 \ensuremath{\ElsevierGlyph{E214}}

%297d 10621 \ensuremath{\ElsevierGlyph{E215}}

2980 10624 \ensuremath{\Vvert}

%2985 10629 \ensuremath{\ElsevierGlyph{3018}}

2986 10630 \ensuremath{\Elroang}

2993 10643 \ensuremath{<\kern-0.58em(}

%2994 10644 \ensuremath{\ElsevierGlyph{E291}}

%2999 10649 \ensuremath{\Elzddfnc}

299c 10652 \ensuremath{\Angle}

%29a0 10656 \ensuremath{\Elzlpargt}

%29b5 10677 \ensuremath{\ElsevierGlyph{E260}}

%29b6 10678 \ensuremath{\ElsevierGlyph{E61B}}
...
%29ca 10698 \ensuremath{\ElzLap}

%29cb 10699 \ensuremath{\Elzdefas}

29cf 10703 \ensuremath{\LeftTriangleBar}

29d0 10704 \ensuremath{\RightTriangleBar}

%29dc 10716 \ensuremath{\ElsevierGlyph{E372}}
...
%2a10 10768 \ensuremath{\ElsevierGlyph{E395}}
...
%2a2d 10797 \ensuremath{\ElsevierGlyph{E25C}}

%2a2e 10798 \ensuremath{\ElsevierGlyph{E25D}}

%2a2f 10799 \ensuremath{\ElzTimes}

2a32 10802 \ensuremath{\btimes}

%2a34 10804 \ensuremath{\ElsevierGlyph{E25E}}

%2a35 10805 \ensuremath{\ElsevierGlyph{E25E}}
...
%2a53 10835 \ensuremath{\ElzAnd}

%2a54 10836 \ensuremath{\ElzOr}

%2a55 10837 \ensuremath{\ElsevierGlyph{E36E}}

2a56 10838 \ensuremath{\ElOr}

2a5e 10846 \ensuremath{\perspcorrespond}

%2a5f 10847 \ensuremath{\Elzminhat}

%2a63 10851 \ensuremath{\ElsevierGlyph{225A}}
...
%2aeb 10987 \ensuremath{\ElsevierGlyph{E30D}}

2af4 10996 \ensuremath{\interleave}

%2af6 10998 \ensuremath{\Elztdcol}

2afd 11005 \ensuremath{{{/}\!\!{/}}}

%300a 12298 \ensuremath{\ElsevierGlyph{300A}}

%300b 12299 \ensuremath{\ElsevierGlyph{300B}}

%3018 12312 \ensuremath{\ElsevierGlyph{3018}}

%3019 12313 \ensuremath{\ElsevierGlyph{3019}}
